...
mdp = mdp_realistic.mdp_realistic(mdp_duration, hdg0, speed0, history_duration, mdp_step, time_step)
...
MDP INIT
'''
state = mdp.initializeMDP(truewindheading, truewindheading_std)
...
for time in range(SIMULATION_TIME):
    ...
    nex_state, reward = mdp.transition(action, truewindheading,truewindheading_std)
    next_state = state
